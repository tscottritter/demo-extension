...
console.log('content script sending number of words replaced at ' + new Date().getMilliseconds())
chrome.runtime.sendMessage({ message: 'Words replaced', count: wordReplacementCount })
